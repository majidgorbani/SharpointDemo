...
namespace StockPhoneSystem {
	using System;
	
	
	public partial class SpsDataContext : Microsoft.SharePoint.Linq.DataContext {
		
		#region Extensibility Method Definitions
		partial void OnCreated();
		#endregion
		
		public SpsDataContext(string requestUrl) : 
				base(requestUrl) {
			this.OnCreated();
		}
		...
		[Microsoft.SharePoint.Linq.ListAttribute(Name="ThreeStateDemo")]
		public Microsoft.SharePoint.Linq.EntityList<ThreeStateDemoDocument> ThreeStateDemo {
			get {
				return this.GetList<ThreeStateDemoDocument>("ThreeStateDemo");
			}
		}
	}
	...
	[Microsoft.SharePoint.Linq.DerivedEntityClassAttribute(Type=typeof(ThreeStateDemoDocument))]
	...
	/// Create a new document.
	/// </summary>
	[Microsoft.SharePoint.Linq.ContentTypeAttribute(Name="Document", Id="0x0101", List="ThreeStateDemo")]
	public partial class ThreeStateDemoDocument : Document {
		
		private System.Nullable<int> _threeStateWF;
		
		private System.Nullable<ItemStatus> _itemStatus;
		...
		public ThreeStateDemoDocument() {
			this.OnCreated();
		}
		
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="ThreeSta", Storage="_threeStateWF", ReadOnly=true, FieldType="WorkflowStatus")]
		public System.Nullable<int> ThreeStateWF {
			get {
				return this._threeStateWF;
			}
			set {
				if ((value != this._threeStateWF)) {
					this.OnPropertyChanging("ThreeStateWF", this._threeStateWF);
					this._threeStateWF = value;
					this.OnPropertyChanged("ThreeStateWF");
				}
			}
		}
		
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="ItemStatus", Storage="_itemStatus", FieldType="Choice")]
		public System.Nullable<ItemStatus> ItemStatus {
			get {
				return this._itemStatus;
			}
			set {
				if ((value != this._itemStatus)) {
					this.OnPropertyChanging("ItemStatus", this._itemStatus);
